...
public class Player
{
    ...
    public void Render()
    {
        ...
        #region LineCollisionWithCircle
        ...
        {
            DevMath.Vector2 _endPointOfLine = line.Position + new DevMath.Vector2(distanceTraveled,0);

            DevMath.Vector2 _perpendicular = line.ClosestPointOnline(Position.x, Position.y,
                    _endPointOfLine.x, _endPointOfLine.y, _enemy.Circle.Position.x, _enemy.Circle.Position.y);

            GUI.DrawTexture(new Rect(_perpendicular.x, _perpendicular.y, 5, 5), visual);
